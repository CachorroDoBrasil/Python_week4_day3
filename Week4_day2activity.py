...
# #printing the entire statement in uppercase
# print(sentence.upper())
# sentence2 = "ESPN IS THE BEST SPORTS NETWORK"
# #printing the sentence in lowercase
# print(sentence2.lower())
# print(sentence.find("electronic"))
# print(sentence.replace("electronic", "electronic".upper()))

# print(sentence.find("equivalent"))
...
# modified_sentence = print(new_sentence.replace("hard", "easy").replace("bad", "good"))
...
# #prints a sentence split with commas by default
# print(sentence4.split(","))
# #removes commas
# print(sentence4.split("p")) 
# #removes all letter A's

# #concatenate words in python reptition 15 times
# result = "Repitition " * 15
# print(result)

#find the first paragraph in the declaration of independence
#plkace it in a variable called first_paragraph
#replace the word "people" with "citizens" in the first paragraph, remove spaces and add emojis for commas
#print it 
...
first_paragraph_M = print(first_paragraph.replace("People", "citizens").replace(",", "💀").replace(" ",""))
